...
export const Youtube = memo(({size = 24, className = ""}: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
         stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path
            d="M2.5 7.1C2.6 5.9 3.5 5 4.7 4.9 7.1 4.7 12 4.7 12 4.7s4.9 0 7.3.2c1.2.1 2.1 1 2.2 2.2.2 1.6.2 4.6.2 4.6s0 3-.2 4.6c-.1 1.2-1 2.1-2.2 2.2-2.4.2-7.3.2-7.3.2s-4.9 0-7.3-.2c-1.2-.1-2.1-1-2.2-2.2C2.3 14.8 2.3 11.8 2.3 11.8s0-3 .2-4.7z"></path>
