import type {FAQItemData, Opinion, Project} from './types';
...
export const faqsData: FAQItemData[] = [
    ...
    },
    {
        ...
        a: "Oczywiście. Zależnie od wybranej technologii oraz stanu początkowego Twojego dachu, udzielamy pisemnej gwarancji od 5 do nawet 20 lat na szczelność nałożonej powłoki."
    },
    {
        q: "Czy przed hydroizolacją natryskową trzeba zrywać starą papę?",
        a: "W 90% przypadków nie ma takiej potrzeby. Nasze systemy są zaprojektowane tak, aby tworzyć bezspoinową, elastyczną warstwę bezpośrednio na starym podłożu. To oszczędza Twój czas, nerwy i pieniądze potrzebne na kosztowną utylizację papy."
    },
    {
        q: "Jakie są przewagi malowania hydrodynamicznego nad wałkiem?",
        a: "To przede wszystkim czas (nawet 10-krotnie szybciej), idealnie gładka struktura bez smug czy śladów po wałku oraz możliwość dotarcia do najdrobniejszych zakamarków i porów na elewacjach czy trudnych strukturach dachowych."
    },
    {
        q: "Czy malujecie i kładziecie gładzie tylko na zewnątrz?",
        a: "Nie. Nasz nowoczesny park maszynowy pozwala nam na wykonywanie gładzi polimerowych i malowania hydrodynamicznego wewnątrz budynków (domy jednorodzinne, biura, obiekty użyteczności publicznej)."
    },
    {
        q: "Kiedy najlepiej zarezerwować termin realizacji?",
        a: "Ze względu na sezonowość branży budowlanej (prace zewnętrzne są silnie uzależnione od pogody), zachęcamy do kontaktu z 1-2 miesięcznym wyprzedzeniem. Zdarzają się jednak okienka w grafiku, więc warto pytać o wolne terminy na bieżąco!"
    }
];
