      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-md border border-slate-100 prose prose-slate max-w-none text-slate-600">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-4">
            ...
            <li><strong>Analitycznych:</strong> Do tworzenia anonimowych statystyk, które pomagają nam zrozumieć, w jaki sposób użytkownicy korzystają ze strony, co umożliwia ulepszanie jej struktury i zawartości (np. poprzez Google Analytics).</li>
