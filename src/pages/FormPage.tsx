...
import { CheckCircle2, Send, Loader2, ClipboardList, FileText, User, Phone, Mail, Box, MessageSquare } from 'lucide-react';
...
export default function FormPage() {
    ...
    if (status === 'success') {
        return (
            <div className="min-h-screen pt-32 pb-24 bg-slate-50 flex items-center justify-center px-4 animate-in zoom-in-95 duration-300">
                <div className="max-w-xl w-full bg-white rounded-3xl p-8 md:p-12 border border-slate-100 shadow-2xl text-center flex flex-col items-center">
                    ...
                    <p className="text-slate-600 mb-8 leading-relaxed">
                        Dziękujemy za przesłanie szczegółów dotyczących Twojego obiektu. Nasi inżynierowie przystąpili już do analizy technicznej. Skontaktujemy się z Tobą najszybciej jak to możliwe, aby omówić szczegóły.
                    </p>
                    <button
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-600 text-base max-w-xl mx-auto leading-relaxed">
                        Przeanalizujemy specyfikę architektoniczną Twojego obiektu i przygotujemy dla Ciebie dedykowaną, kompleksową ofertę.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-2">Rodzaj usługi</label>

                                    {isServicePreselected ? (
                                        // WERSJA A: Jeśli użytkownik przyszedł z kafelka - pokazujemy piętrowy układ
                                        <div className="w-full px-4 py-3 rounded-xl border border-brand-primary/30 bg-brand-primary/5 shadow-inner flex flex-col items-start gap-2">
                                            <span className="flex items-start sm:items-center text-slate-900 font-bold text-sm leading-snug">
                                                <Box size={16} className="text-brand-primary mr-2.5 mt-0.5 sm:mt-0 flex-shrink-0" />
                                                {serviceType}
                                            </span>
                                            <span className="text-[10px] bg-brand-primary/15 text-brand-primary px-2.5 py-1 rounded-full font-bold uppercase tracking-wider select-none ml-6">
                                                Wybrana usługa
                                            </span>
                                        </div>
                                    ) : (
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                ...
                                                <option value="Hydroizolacje Dachów i Tarasów">Hydroizolacje Dachów i Tarasów</option>
                                                <option value="Posadzki Żywiczne">Posadzki Żywiczne</option>
                                                <option value="Malowanie Hydrodynamiczne">Malowanie Hydrodynamiczne</option>
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-2">Szacunkowy metraż (m²)</label>
                                    <div className="relative">
                                        <input
                                            type="text"
                                            required
                                        ...
                                        />
                                        <div className="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400 text-xs font-semibold select-none">
                                            m²
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-6">
                                <label className="block text-sm font-semibold text-slate-700 mb-2">Opis sytuacji / Stan aktualny obiektu</label>
                                <div className="relative">
                                    <textarea
                                        required
                                        rows={4}
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-2">Imię i nazwisko / Nazwa firmy</label>
                                    <div className="relative">
                                        <input
                                            type="text"
                                            required
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-2">Numer telefonu</label>
                                    <div className="relative">
                                        <input
                                            type="tel"
                                            required
                        ...
                        {/* Komunikat o błędzie */}
                        {status === 'error' && (
                            <div className="bg-red-50 text-red-600 text-sm p-4 rounded-xl border border-red-100 text-center animate-in fade-in">
                                Wystąpił błąd serwera podczas wysyłania wiadomości. Spróbuj ponownie za chwilę lub użyj zakładki Kontakt.
                            </div>
                        )}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-slate-100 items-center">
                            ...
                            >
                                {status === 'submitting' ? (
                                    ...
                                    <>Poproś o szczegółową ofertę <Send size={16} className="ml-2 group-hover:translate-x-0.5 transition-transform"/></>
                                )}
                            </button>
